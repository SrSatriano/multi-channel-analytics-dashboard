...
Obrigado por considerar uma contribuição para **Dashboard analítico multicanal**.

## Como começar

1. Faça um fork do repositório [multi-channel-analytics-dashboard](https://github.com/SrSatriano/multi-channel-analytics-dashboard).
