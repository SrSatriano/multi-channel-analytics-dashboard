# Guia de deploy — Dashboard analítico multicanal

> Versão **1.0.0** · Stack: **Next.js 14, Tailwind CSS, Recharts, TypeScript**
...
3. Execute `npm run build` ou smoke tests automatizados.
